// Espero que no me de problemas legales solo le hice una modificación XD
  ...
  var e = (() => {
    ...
    return (e) => {
      const t = e.regex,
        ...
        d = {
          className: "title",
          begin: t.optional(s) + e.IDENT_RE,
          relevance: 0,
        },
        _ = t.optional(s) + e.IDENT_RE + "\\s*\\(",
        u = {
          keyword: [
            "asm",
            "auto",
        ...
        m = [c, i, n, e.C_BLOCK_COMMENT_MODE, o, l],
        g = {
          variants: [
            { begin: /=/, end: /;/ },
            {
            ...
            { relevance: 0, match: /,/ },
            {
              ...
              contains: [
                ...
                i,
                {
                  ...
                  keywords: u,
                  relevance: 0,
                  contains: ["self", n, e.C_BLOCK_COMMENT_MODE, l, o, i],
                },
              ],
            },
            i,
